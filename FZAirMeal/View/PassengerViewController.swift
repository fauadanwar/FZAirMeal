...
extension PassengerViewController : UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let passenger = passengerDataProvider.fetchedResultController.object(at: indexPath).convertToRecord()
        cell.lblMaelTitle.text = "Meal:"
        cell.lblMealName.text = passenger?.Order?.meal.name ?? "No Order"
